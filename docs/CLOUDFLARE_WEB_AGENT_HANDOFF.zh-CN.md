...
- 当前主站匿名公开阅读已获用户批准。预览 URL 与非主分支自动构建关闭；预览受限 Access 及读者身份验证仍未完成。正式生态 URL、四库 About Website、DNS、GitHub Pages 和原 Pages holding 未切换或停用；未批准付费升级。
...
常规配置与验证已获授权。只有登录/MFA、新增 GitHub App 授权、读者身份批准、域名或 DNS 授权、秘密直接输入、正式 public cutover 才交还用户；届时给出确切链接与步骤。不得因当前主站公开而使预览或其他项目公开。
